...
##      - The output plot file is named plot2.png.
##
#########################################################################################################################################
...
##  Generate a plot using the following parameters:
...
##      -   y axis label (xlab):    Global Active Power (kilowatts)

    plot(filtered_df$DateTime,filtered_df$Global_active_power,type="n", xlab = "", ylab = "Global Active Power (kilowatts)")
